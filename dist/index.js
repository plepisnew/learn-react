...
app.use('/build/', express_1.default.static(path.join(__dirname, 'node_modules/three/build')));
app.use('/jsm/', express_1.default.static(path.join(__dirname, 'node_modules/three/examples/jsm')));
