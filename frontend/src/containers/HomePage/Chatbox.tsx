...
const Chatbox: React.FC = () => {
    ...
    const getMessages = () => {
        ...
        if (apparentData)
            return apparentData.map((message) => (
                <div className="message-container" key={message.createdAt}>
                    <span className="time-stamp">
                        {parseTime(message.createdAt).hourMinute}
                    </span>
    ...
    return (
        <StyledChatbox>
            <div
                className={`chatbox ${
                    open ? 'open-chatbox' : 'closed-chatbox'
                }`}
            >
                <div
