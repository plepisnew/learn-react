...
import TetrisPiece, { pieces as tetrisPieces } from 'modules/drawable/TetrisPiece';
...
const GamePanel: React.FC = () => {
    ...
    const [currentPiece, setCurrentPiece] = useState<TetrisPiece>(randomPiece());
